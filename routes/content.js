...
router.get("/content/genre/:genreid", authorize, ContentController.getAllContentGenre);
...
router.get("/getfavoriteContent", authorize, ContentController.getfavoriteContent);
...
router.post("/content/favorupload", authorize, Content, ContentController.favoruploadContent);
